...
document.addEventListener('DOMContentLoaded', function() {
    console.log('QuizTantra- Shared JS Loaded');
...
function createCategoryCards() {
    ...
    Object.entries(quizData).forEach(([key, category]) => {
        ...
        card.href = 'playquiz.html';
        card.innerHTML = `
            <img src="${category.image}" alt="${category.title}" onerror="this.src='https://images.unsplash.com/photo-1635070041078-e363dbe005cb?w=300'">
